...
export const FETCH_MENU_URL =
  "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=18.5204303&lng=73.8567437&submitAction=ENTER&restaurantId=";

export const restaurantList = [
  {
    type: "restaurant",
    data: {
      menu: { items: ["Classic Biryani Combo", "Smoky Grilled Chicken Biryani Combo","Stay Home Bucket","Chicken Bucket for Two","Mingles Bucket Meal","Big 8 - Chicken Bucket","Hot & Crispy Chicken -8pc"] },
      type: "F",
      id: "73011",
      name: "KFC",
  ...
  },
  {
    type: "restaurant",
    data: {
      menu: { items: ["7 Simply Veg Pizza", "10 Simply Veg Pizza"] },
      type: "F",
      id: "542132",
      name: "Domnik Pizza",
...
export const restaurantMenu = [
  {
    ...
    avgRating: "",
    costForTwo: "",
    menu: { items: ["chicken Burger", "chicken fried burger"] },
  },
  {
    id: "542132",
    name: "Domnik Pizza",
    ...
    avgRating: "",
    costForTwo: "",
    menu: { items: ["chicken Pizza", "chicken fried Pizza"] },
  },
...
export const menuCard = {
  card: {
    ...
    info: {
      id: "98443324",
      name: "Chicken Biryani combo - for 2",
      category: "Weekend Deals",
      description:
        "Weekends are for Biryani! Enjoy this new combo of 2 Popcorn Biryani Buckets served with 2 Spicy Gravies, 2pc Hot & Crispy, Medium Fries & a Pepsi PET 475ml -at a deal price",
      imageId: "zplov25cvr3t6fe95e7b",
      inStock: 1,
      price: 79524,
      variants: {},
      variantsV2: {},
